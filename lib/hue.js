...
module.exports = internals.Hue = function Hue(username, ip) {
  ...
  internals.debug('Attached an Event Emitter instance to the new hue instance');
  ...
  if (!ip) {
    ...
    this.discover().bind(this).then(function(results) {
      ...
      if (results[0] && results[0].internalipaddress) {
        ...
        this._bridge = new Bridge(this, results[0].internalipaddress);
      } else {
    ...
    this._bridge = new Bridge(this, ip);
  }
...
Hoek.inherits(internals.Hue, Kilt);
